...
ALLOWED_HOSTS = ['127.0.0.1', '137.184.10.254', 'www.clases.miel.org', 'clases.miel.org']
CSRF_TRUSTED_ORIGINS = ["http://127.0.0.1", "https://clases.miel.org", "https://www.clases.miel.org"]
...
AUTH_USER_MODEL = 'classApp.CustomUser'
